...
import org.jetbrains.kotlin.formver.embeddings.isInheritorOfCollectionTypeNamed
...
sealed interface PresentInterface : StdLibReceiverInterface {
    ...
    override fun match(function: NamedFunctionSignature): Boolean =
        function.callableType.receiverType?.pretype?.isInheritorOfCollectionTypeNamed(interfaceName) ?: false
}
